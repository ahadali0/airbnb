    ...
    <div className="bg-gray-100 sticky top-0 z-50 transition-all duration-300 w-full">
      <LayoutWrapper>
        ...
        >
                  ...
                  <div className="flex gap-3 items-center">
                    {navLinkData.map((link, index) => (
                      <div
                        ...
                        className={`relative cursor-pointer flex flex-row items-center border-b-2 ${
                          selectedIndex === index
                            ? "border-black"
                            : "border-transparent"
                        }`}
          ...
          <div className="flex w-60 justify-end gap-2 mt-3">
        ...
        <div className="w-full px-4 lg:hidden md:hidden block">
          <div className="bg-white text-center flex items-center justify-center gap-3 py-3 rounded-full">
            <span>
              <Search />
            </span>
        ...
        <div className="flex justify-evenly gap-3 items-center">
          {bottomBarTab.map((link, index) => (
            <div
              key={index}
              onClick={() => setSelectedIndex(index)}
              className={`relative cursor-pointer flex flex-col justify-evenly items-center border-b-2 ${
